...
tinit = time.process_time()
I = [2, 10, 70]
nn = SP.search(I,limitexp = 3000000, limitdepth = 10, tickets = [15, 10, 8])
tend = time.process_time()
print("Time: %.1fms"%((tend-tinit)*1000))
...
tinit = time.process_time()
I = [2, 10, 70]
nn = SP.search(I,limitexp = 3000000, limitdepth = 10, tickets = [15, 10, 8], anyorder = True)
tend = time.process_time()
print("Time: %.1fms"%((tend-tinit)*1000))
if validatepath(nn,I,U, tickets = [15, 10, 8]):
        print("Path: {}".format(nn))
...
tinit = time.process_time()
I = [30,40,109]
nn = SP.search(I,limitexp = 2000000)
tend = time.process_time()
print("Time: %.1fms"%((tend-tinit)*1000))
if validatepath(nn,I,U):
        print("Path: {}".format(nn))
...
tinit = time.process_time()
I = [30,40,109]
nn = SP.search(I,limitexp = 3000000, limitdepth = 10, tickets = [5,10,2])
tend = time.process_time()
print("Time: %.1fms"%((tend-tinit)*1000))
...
tinit = time.process_time()
I = [30,40,109]
nn = SP.search(I,limitexp = 3000000, limitdepth = 10, tickets = [5,6,2], anyorder = True)
tend = time.process_time()
print("Time: %.1fms"%((tend-tinit)*1000))
...
tinit = time.process_time()
I = [100,99,98]
nn = SP.search(I,limitexp = 4000000, limitdepth = 10, tickets = [10,10,3])
tend = time.process_time()
print("Time: %.1fms"%((tend-tinit)*1000))
...
tinit = time.process_time()
I = [100,99,98]
nn = SP.search(I,limitexp = 3000000, limitdepth = 10, tickets = [5,15,3], anyorder = True)
tend = time.process_time()
print("Time: %.1fms"%((tend-tinit)*1000))
...
tinit = time.process_time()
I = [50,51,52]
nn = SP.search(I,limitexp = 3000000, limitdepth = 10, tickets = [10,5,0])
tend = time.process_time()
print("Time: %.1fms"%((tend-tinit)*1000))
...
tinit = time.process_time()
I = [50,51,52]
nn = SP.search(I,limitexp = 7000000, limitdepth = 10, tickets = [5,10,8], anyorder = True)
tend = time.process_time()
print("Time: %.1fms"%((tend-tinit)*1000))
